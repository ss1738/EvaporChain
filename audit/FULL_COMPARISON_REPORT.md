...
> ## ⚠️ ARCHIVED 2026-05-07 — HISTORICAL SNAPSHOT
>
> This file is a frozen competitive-research snapshot from **2026-03-26**. It pre-dates the entire doctrine arc (Light-Cone DAG, Crooks-MEV, Lambda-Fold Nova, Decay-BFT mechanization, V2-hardened layers) and predates the audit-closure work in `AUDIT_2026_05_06.md`.
>
> Verified 2026-05-07: **zero live cross-references** to this file from any current doc — the strategic-narrative pivot superseded it without any of its findings flowing into a maintained pipeline.
>
> Kept for historical context only. For current strategic positioning use:
>
> - **`research/INEVITABILITY_STRATEGY.md`** — current 5-year strategic anchor
> - **`research/INVENTION_STACK.md`** — Tier-0 frontier primitives (the actual moat, post-March pivot)
> - **`AUDIT_2026_05_06.md`** — current audit state
> - **`DOCTRINE_PUNCH_LIST.md`** — current build plan
>
> Do not edit this file to "update the comparison" — open a new doc instead. This file's role now is purely to lock the March-26 snapshot in place.
