...
- [x] **Full substrate integration test coverage** — DONE 2026-04-29: 358 tests across 61 modules in `tests/integration/src/lib.rs`; all crates covered including oracle consensus/state, mempool MEV, encrypted mempool, validator slashing, state snapshots, DA namespace, block_da, evaporation_da, pruning, and light-client sampler
