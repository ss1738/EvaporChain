# EvaporChain — Remaining Work (DEPRECATED 2026-05-07)

> ## ⚠️ DEPRECATED — DO NOT USE AS A LIVE PUNCH LIST
>
> This file is a frozen snapshot from **2026-04-23**. It predates the entire doctrine-layer arc (Layer 0–7 substrate-shipping, V2 hardenings, MCP server, Decay-BFT mechanization track, etc.) and is preserved only for historical context.
>
> For the current state-of-the-chain:
>
> - **`DOCTRINE_PUNCH_LIST.md`** — current layered build plan + Layer 0–7 status (authoritative live punch list)
...
> - **`IMPOSSIBLE_RESEARCH_STACK.md`** — research-track roadmap
>
> Do not edit this file to "update progress" — add new entries to `DOCTRINE_PUNCH_LIST.md` instead. This file's role now is purely to lock the April-23 snapshot in place so future audits can diff against it.

---

## Historical snapshot (2026-04-23)

Full audit completed across all docs, research, crates, tests, SDK, wallet, dapps, security, and infrastructure. This was the complete punch list **as of 2026-04-23** — the items below have either been shipped, superseded by the doctrine arc, or rolled into `DOCTRINE_PUNCH_LIST.md` / `AUDIT_2026_05_06.md`.
