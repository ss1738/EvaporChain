...
fn main() {
    let crc = extract_compressed_round_constants("/tmp/neptune-bn256-standard.json").expect("extract");
    println!("crc len: {}", crc.len());
    println!("expected (arity-24 standard): {}", expected_crc_len(8, 59, 25));
    println!("first 3 entries non-zero: {} {} {}",
