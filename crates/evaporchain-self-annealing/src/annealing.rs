...
pub fn accepts_candidate(
    ...
    let threshold = (t as u128 * NONCE_MOD as u128)
        / ((t as u128).saturating_add(delta as u128).max(1));
...
mod tests {
    ...
    fn params(lambda: u64) -> AnnealingParams {
        AnnealingParams { lambda_half_life: lambda, beta_mb: 1_000 }
    }
    ...
    fn accepts_better_candidate_always() {
        let p = params(4096);
        let weak  = AnnealedScore { stake: 100,   activity: 0,  uptime_milli: 500 };
    ...
    fn rejects_worse_at_zero_temperature() {
        ...
        let p = AnnealingParams { lambda_half_life: 0, beta_mb: 1_000 };
        let strong = AnnealedScore { stake: 1_000, activity: 10, uptime_milli: 1_000 };
        let weak   = AnnealedScore { stake: 100,   activity: 0,  uptime_milli: 500 };
    ...
    fn high_temperature_accepts_some_degrading_moves() {
        ...
        let p = params(10_000);
        let strong = AnnealedScore { stake: 10_000, activity: 50, uptime_milli: 1_000 };
        let barely_worse = AnnealedScore { stake: 9_999, activity: 50, uptime_milli: 1_000 };
