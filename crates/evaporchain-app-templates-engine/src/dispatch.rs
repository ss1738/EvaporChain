...
use crate::{
    ...
    init_gallery_forgets, init_lottery, init_mayfly, init_mnemochain, init_mortal_dao,
    init_mortal_message, init_mortal_nft, init_multisig, init_open_bounty, init_oracle_feed,
    init_payment_split, init_refresh_market, init_sap, init_sbav, init_scl, init_sddc,
    init_sealed_bid_auction,
