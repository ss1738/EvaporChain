...
// Phase 2 + 4 (2026-05-08): light-client types + LightClientVerifier
// moved to `evaporchain-consensus-types`. Re-exported here so all
// existing callers (`evaporchain_consensus::light_client::*`) keep
// working unchanged.
pub use evaporchain_consensus_types::{
    bls_vote_message, LightBlockHeader, LightClientError, LightClientVerifier, TrustedState,
    VerificationResult, MAX_SKIP_HEIGHT_GAP, TRUST_PERIOD_SECS, TRUST_THRESHOLD_DENOMINATOR,
