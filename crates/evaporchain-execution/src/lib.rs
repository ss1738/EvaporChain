    ...
    fn execute_block(
        ...
        for tx in &block.transactions {
            ...
            let result = match tx {
                ...
                // Gated on the single shared flag. SIBLING: identical guards
                // live in parallel.rs and block_stm.rs — re-enable ALL THREE
                // executors (and the mempool admission gate) together.
