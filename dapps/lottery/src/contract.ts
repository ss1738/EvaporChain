// Single source of truth: `contracts/evaporscript/lottery.es`.
// Cargo pilot: `crates/evaporchain-script/tests/lottery_pilot.rs`.

export const LOTTERY_SOURCE = `contract Lottery {
    state {
        operator: address
        prize: u64 = 0
        stake: u64 = 0
