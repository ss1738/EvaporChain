            ...
            <div className="rounded-lg border border-evap-border overflow-hidden">
              ...
              <div className="divide-y divide-evap-border">
                {sortedCredits.map((c) => (
                  ...
                  >
                    <span
                      className="col-span-6 text-[10px] font-mono text-zinc-300 truncate"
                      title={c.namespace_hex}
                    >
                      {c.namespace_hex.slice(0, 16)}…
                    </span>
                    <span className="col-span-3 text-[10px] font-semibold text-zinc-200 text-right tabular-nums">
                      {c.accrued.toLocaleString()}
                    </span>
                    <span className="col-span-3 text-[10px] text-zinc-500 text-right tabular-nums">
